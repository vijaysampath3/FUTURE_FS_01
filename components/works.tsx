...
const projects = [
  ...
  },
  {
    ...
    category: "Web",
    description: "Full-stack real-time chat app with Socket.io for live messaging, user authentication and persistent chat history using MongoDB.",
    image: "/images/project-4.jpg",
    tags: ["React", "TypeScript", "Socket.io", "MongoDB", "REST APIs"],
    liveUrl: "#",
    githubUrl: "#",
    externalUrl: "",
  },
